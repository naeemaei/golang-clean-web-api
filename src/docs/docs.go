...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_naeemaei_golang-clean-web-api_api_dto.CreateUpdateCarModelImageRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_naeemaei_golang-clean-web-api_api_dto.CreateUpdateCarModelImageRequest": {
            "type": "object",
            "required": [
                "carModelId",
                "imageId"
