...
type PropertyCategoryService struct {
	base *BaseService[models.PropertyCategory, dto.CreateUpdatePropertyCategoryRequest, dto.CreateUpdatePropertyCategoryRequest, dto.PropertyCategoryResponse]
}
...
func NewPropertyCategoryService(cfg *config.Config) *PropertyCategoryService {
	return &PropertyCategoryService{
		base: &BaseService[models.PropertyCategory, dto.CreateUpdatePropertyCategoryRequest, dto.CreateUpdatePropertyCategoryRequest, dto.PropertyCategoryResponse]{
			...
			Preloads: []preload{{Base: "Properties"}},
		},
	}
}

// Create
func (s *PropertyCategoryService) Create(ctx context.Context, req *dto.CreateUpdatePropertyCategoryRequest) (*dto.PropertyCategoryResponse, error) {
	return s.base.Create(ctx, req)
}

// Update
func (s *PropertyCategoryService) Update(ctx context.Context, id int, req *dto.CreateUpdatePropertyCategoryRequest) (*dto.PropertyCategoryResponse, error) {
