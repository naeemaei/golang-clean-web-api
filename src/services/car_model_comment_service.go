...
func NewCarModelCommentService(cfg *config.Config) *CarModelCommentService {
	return &CarModelCommentService{
		base: &BaseService[models.CarModelComment, dto.CreateUpdateCarModelCommentRequest, dto.CreateUpdateCarModelCommentRequest, dto.CarModelCommentResponse]{
			...
			Preloads: []preload{{string: "User"}},
			
		}}
}

// Create
func (s *CarModelCommentService) Create(ctx context.Context, req *dto.CreateUpdateCarModelCommentRequest) (*dto.CarModelCommentResponse, error) {
	return s.base.Create(ctx, req)
}

// Update
func (s *CarModelCommentService) Update(ctx context.Context, id int, req *dto.CreateUpdateCarModelCommentRequest) (*dto.CarModelCommentResponse, error) {
