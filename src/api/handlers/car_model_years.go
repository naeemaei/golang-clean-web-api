...
// @Success 201 {object} helper.BaseHttpResponse{result=dto.CarModelYearResponse}
...
// @produces json
// @Param id path int true "Id"
// @Success 200 {object} helper.BaseHttpResponse{result=dto.CarModelYearResponse}
// @Failure 400 {object} helper.BaseHttpResponse "Bad request"
...
// @Success 200 {object} helper.BaseHttpResponse{result=dto.PagedList[dto.CarModelYearResponse],validationErrors=any}
